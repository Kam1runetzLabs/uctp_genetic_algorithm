...
cmake --build _builds
./_builds/tests/unit_tests/genetic_algorithm_tests
...
cmake -H. -B_builds $CMAKE_OPTIONS
cmake --build _builds
valgrind --tool=memcheck --leak-check=full --track-origins=yes ./_builds/tests/unit_tests/genetic_algorithm_tests
